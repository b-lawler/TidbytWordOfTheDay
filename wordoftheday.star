...
def main(config):
	...
	WORD_OF_DAY = "https://api.wordnik.com/v4/words.json/wordOfTheDay?api_key=" + API_Key_Wordnik

	response = http.get(WORD_OF_DAY)
	...
	part_of_speech = response.json()["definitions"][0]["partOfSpeech"]
